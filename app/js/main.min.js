...
$(function(){$(".header__slider-wrapper a, .header__logo-link, .footer__logo-link").on("click",function(e){e.preventDefault();e=$(this).attr("href"),e=$(e).offset().top;$("body,html").animate({scrollTop:e},1500)}),$(document).on("scroll",function(){50<$(document).scrollTop()?$(".header__top").addClass("header__top--thin"):$(".header__top").removeClass("header__top--thin")}),$(".header__slider").slick({vertical:!0,arrows:!1,slidesToShow:4,initialSlide:3,speed:1500}),$(".dot-0").on("click",function(e){e.preventDefault(),$(".header__slider").slick("goTo",3)}),$(".dot-1").on("click",function(e){e.preventDefault(),$(".header__slider").slick("goTo",2)}),$(".dot-2").on("click",function(e){e.preventDefault(),$(".header__slider").slick("goTo",1)}),$(".dot-3").on("click",function(e){e.preventDefault(),$(".header__slider").slick("goTo",0)})});